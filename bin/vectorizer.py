...
def create_faiss_db():
    ...
    dimension = embedding_model._client.get_sentence_embedding_dimension() # dimensión vectorial para el modelo de embeddings (384 dimensiones para 'BAAI/bge-small-en-v1.5')
